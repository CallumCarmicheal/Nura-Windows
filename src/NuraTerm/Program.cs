...
public sealed class NuraAppSettings {
    public string SupressReleaseVersion { get; set; } = string.Empty;
...
static class Program {
    ...
    public  static CancellationToken Cts = AppCts.Token;
    ...
    public static NuraAppSettings AppSettings = new();
    ...
    static async Task Main(string[] args) {
        ...
        try {
            ...
            await updater.HandleUpdatesAsync(AppCts.Token).ConfigureAwait(false);

            // Run your app here.
            await RunAsync(wasAppSettingsCreated).ConfigureAwait(false);
    ...
    private static async Task RunAsync(bool wasAppSettingsCreated) {
...
// Helper methods
    ...
    public static void SaveAppSettings() => SaveAppSettings(AppSettingsPath, AppSettings);
    public static void SaveAppSettings(string path, NuraAppSettings settings) {
